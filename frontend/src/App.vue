...
const tiktokCatalogTypeTab = ref<'tiktok_local'|'tiktok_cross_border'>('tiktok_local')
...
function tiktokCatalogTypeLabel(type: string) { return type === 'tiktok_cross_border' ? 'tk跨境店' : 'tk本土店' }
...
async function refreshTiktokCatalogList() {
  ...
  } catch(e:any) { tiktokCatalogError.value = e.response?.data?.detail || '刷新 TK 类目列表失败' }
